...
import upstox.UpstoxWebSocketSubscriber;
 ...
 * @author Advance
 */
public class UpstoxSendKeys implements Runnable {
    ...
    public UpstoxSendKeys(ChildAccount cAccount, ArrayList<JSONObject> obj, String from) {
    ...
    public void connectToSocket() throws DeploymentException, IOException, InterruptedException {
        ...
        subscribers.add(new UpstoxWebSocketSubscriber(cAccount, obj, from));
    ...
    private Request prepareRequest() {
        return new Request.Builder()
                ...
                .url("wss://ws.upstox.com/socket.io/?apiId=" + appId + "&token=" + token + "&client_id=" + cAccount.getLoginId() + "&ReleaseType=Green&deviceId=-1922472816&EIO=3&transport=websocket")
                .build();
    }
}
